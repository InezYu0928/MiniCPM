...
from peft import LoraConfig, TaskType, get_peft_model, BitsAndBytesConfig
...
if __name__ == "__main__":
    ...
    load_in_4bit=True,
    bnb_4bit_quant_type="qf8",
    bnb_4bit_use_double_quant=True,
    bnb_4bit_compute_dtype=torch.bfloat16,
    )

    model = AutoModelForCausalLM.from_pretrained(model_args.model_name_or_path, torch_dtype=torch.bfloat16, #device_map='cuda',
